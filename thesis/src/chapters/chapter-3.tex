...
\todo{Discuss about MiniEdit here.}

\fig[scale=0.8]{src/img/mini-edit-topology.pdf}{img:mini-edit-topology}{Topology generated with MiniEdit}

The topology configuration file generated from \labelindexref{Figure}{img:mini-edit-topology} can be found entirely in \labelindexref{Listing}{lst:config-one-switch-two-hosts}.